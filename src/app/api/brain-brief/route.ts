      ...
      try {
        const res = await fetch('https://api.anthropic.com/v1/messages', {
          ...
          body: JSON.stringify({
            ...
            system: '次のマーケ・ブリーフから、自社マーケ担当が「今、頭に入れておくべき現状」を抽出。出力は「- 」始まりの箇条書き3〜4行だけ（見出し・前置き・締めの文は一切付けない）。観点=①自社の今の状態 ②競合・市場で起きている変化 ③注意すべき動き。【禁止】「〜せよ/通す/急務/必須/必要/べき/〜しよう/急ぐ」等の"やること・指示・当為"の表現は使わず、純粋に"今こうなっている"という状態・事実・変化としてだけ書く（やることはタスク管理の領域）。創作せずブリーフ内の事実だけ。',
